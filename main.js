...
const gcrevoke = ["523781201906-1621430788@g.us"]
prefix = '/'
shp = '⬡'
owner = "523781201906@s.whatsapp.net"
spc1 = '         '
spc2 = '\n                           '
spc3 = '                   '
spc4 = '               '
require("./index.js");
nocache("./index.js", (module) => console.log(`${module} Ah sido actualizado uh.`));
...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["JUGUITO", "3.0"];
console.log(color(figlet.textSync('juguito', {
font: 'Standard',
...
console.log(color(`[ • CREADOR JUGUITO • ]` ,'brown'))
...
console.log(color(figlet.textSync('Juguito-Bot', {
font: 'Standard',
horizontalLayout: 'default',
vertivalLayout: 'default',
width: 80,
whitespaceBreak: false
  ...
  fs.existsSync("./juguito.json") && client.loadAuthInfo("./juguito.json");
...
await client.connect({ timeoutMs: 30 * 1000 });
  fs.writeFileSync("./juguito.json",JSON.stringify(client.base64EncodedAuthInfo(), null, "\t"));    
    client.on('connecting', () => {
   ...
   //    client.sendMessage("51918303426@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n──────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: false, externalAdReply:{title: "Creador Darlyn",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./dararchivos/imagen/ALONSOZING.jpg'),sourceUrl:"https://wa.me/51918303426?text=Ola"}}})
       ...
       console.log(color('|WRN|', 'pink'), color('Creado por juguito', 'purple'))
...
fkontakk = { key: {
  fromMe: false,
    participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '523781201906-1604595598@g.us' } : {})
},
 message: {
    "contactMessage":{"displayName":'JUGUITO',"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;Darlyn;;;\nFN:Creador\nitem1.TEL;waid=523781201906:+52 378 120 1906\nitem1.X-ABLabel:Mobile\nEND:VCARD"
 }}}
  ...
  client.on("group-participants-update", async (anu) => {
    try {
      ...
      try {
        ...
        pp_user =
          "https://telegra.ph/file/f7991dcf722b112ef09d9.jpg";
      }
      try {
      ...
      if (anu.action == "add" && mem.includes(client.user.jid)) {
        client.sendMessage(anu.jid, "Hola putas, llegue yo", "conversation");
	     ...
	     /*if (anu.action == 'add') {
              ...
              ppimg = 'https://telegra.ph/file/f7991dcf722b112ef09d9.jpg'
              }
              let buff = await getBuffer(ppimg)
              welcomeBut =`_*Salio:*_ *@${num.split('@')[0]}*\n_*Grupo:*_ _*${mdata.subject}*_`
              client.sendMessage(mdata.id, welcomeBut, MessageType.text, {thumbnail: fs.readFileSync('./stik/thumb.jpeg'), contextInfo: { externalAdReply:{title: `Salio de: ${mdata.subject}`,body:"By Juguito",mediaType:"2",thumbnail:buff,sourceUrl:`https://wa.me/51918303426`}, "mentionedJid": [num]}})
              }
                       if (anu.action == 'promote') {
                        ...
                        client.sendMessage(mdata.id, welcomeBut, MessageType.text, {thumbnail: fs.readFileSync('./stik/thumb.jpeg'), contextInfo: { externalAdReply:{title: `Nuevo admin en: ${mdata.subject}`,body:"By Juguito",mediaType:"2",thumbnail:buff,sourceUrl:`https://wa.me/51918303426`}, "mentionedJid": [num]}})
                       }
                        ...
                        client.sendMessage(mdata.id, welcomeBut, MessageType.text, {thumbnail: fs.readFileSync('./stik/thumb.jpeg'), contextInfo: { externalAdReply:{title: `Admin descartado en: ${mdata.subject}`,body:"By Juguito",mediaType:"2",thumbnail:buff,sourceUrl:`https://wa.me/51918303426`}, "mentionedJid": [num]}})
                        }
    } catch (e) {
